...
import { alcipanProducts, similarParagraphs } from "@/constants/data"; // Import the steelProducts array
...
export default function SubcategoryPage() {
  ...
  const product = alcipanProducts.find((product) =>
  ...
  const otherSubcategories = alcipanProducts.filter(
